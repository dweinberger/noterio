...
// ------ Create book object
function Book(title, bookid, author,pub,city,date,translator,issue, journal, vol, article,url,type,misc,tags,numberofnotes,pages, container,note,isbn,parent,nickname){
	this.title = title;
	this.bookid = bookid;
	this.author = author;
	this.pub=pub;
